            ...
            <div className="flex items-center justify-between pt-4 pb-4 flex-wrap border-b-2">
              ...
              <div className="flex items-center gap-x-3 gap-y-2 flex-wrap">
                ...
                <button
                  ...
                  className={`${"bg-[#6418C3] text-white"} ${"w-[180px] text-base rounded-md px-2 py-2 font-medium hover:border-[#6418C3] flex items-center justify-center gap-2"}`}
                >
                  <Icon icon="ci:list-add" width="25" height="25" />
                  Add Obituaries
                </button>
              </div>
            </div>
